    ...
    <Card>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-col shrink-0">
          <button className="hover:bg-indigo-600 mb-4 block w-16 py-2 px-3 bg-indigo-500 text-white text-sm font-semibold rounded-md shadow focus:outline-none transition-colors duration-100 ease-in-out" onClick={onCopy}>复制</button>
